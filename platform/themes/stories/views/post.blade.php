            ...
            <div class="col-md-6">
                <div class="entry-meta align-items-center meta-2 font-small color-muted">
                    @if ($post->author && $post->author->id)
                        <p class="mb-5">
                            <span class="author-avatar"><img class="img-circle" src="{{ $post->author->avatar_url }}" alt="{{ $post->author->name }}"></span>
        ...
        @if ($post->author && $post->author->id)
            ...
            <div class="author-bio p-30 mt-50 border-radius-10 bg-white wow fadeIn  animated" style="visibility: visible; animation-name: fadeIn;">
                <div class="author-image mb-30">
                    <img class="avatar" src="{{ $post->author->avatar_url }}" alt="{{ $post->author->name }}">
                </div>
