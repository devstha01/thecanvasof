        ...
        $data = [
            'en_US' => [
                [
                    ...
                    'content'  =>
                        ...
                        Html::tag('div', '[categories-with-posts category_id_1="3" category_id_2="4" category_id_3="5"][/categories-with-posts]') .
            ...
            'vi'    => [
                [
                    ...
                    'content'  =>
                        Html::tag('div',
                            '[about-banner title="Xin chào, Tôi là &lt;span&gt;Steven&lt;/span&gt;" subtitle="Chào mừng đến với blog của tôi" text_muted="Travel Blogger., Content Writer., Food Guides" image="general/featured.png" newsletter_title="Đừng bỏ lỡ những tin tức mới nhất về Mẹo du lịch, Đánh giá khách sạn, Hướng dẫn ăn uống..."][/about-banner]') .
